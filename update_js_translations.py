...
translations_js = """const translations = {
  ...
  ru: {
    ...
    "founder-quote": "<span style=\\"font-size:4rem; color:var(--burgundy); line-height:0; vertical-align:middle; margin-right:10px;\\">“</span><br>Для меня Образовательная Экосистема Эврика — это не просто учебное заведение — это проявление моей любви к моей стране, моему народу и его будущему прогрессу",
