...
const schools = {
  ...
  4: {
    ...
    name: "Victory Colleges by Evrika Mərkəzi",
...
const translations = {
  az: {
        ...
        "reg-school-eduhome": "Victory Colleges by Evrika Mərkəzi",
        "reg-school-zumrud": "Zümrüd<br>Women<br>Club",
        "reg-submit": "MÜRACİƏTİ TAMAMLA",
        "reg-child-name": "ŞAGİRDİN ADI",
        "reg-child-surname": "ŞAGİRDİN SOYADI",
        "reg-child-sector": "Müraciət etmək istədiyi bölmə",
        "reg-child-age": "Övladınızın yaşı",
        "reg-parent-contact": "Valideyinin əlaqə nömrəsi",
        "reg-your-name": "Adınız",
        "reg-your-surname": "Soyadınız",
        "reg-your-program": "Müraciət etdiyiniz proqram",
        "reg-current-class": "Hal-hazırda oxuduğunuz sinif (və ya məzun)",
        "reg-contact-num": "Əlaqə nömrəsi",
        "reg-your-service": "İştirak etmək istədiyiniz xidmət",
        "reg-your-age": "Yaşınız",
        "reg-pl-age-4": "Məs: 4 və ya 4.5",
        "reg-pl-zumrud": "Məs: Zümrüd",
        "reg-pl-aliyeva": "Məs: Əliyeva",
        "reg-pl-grade10": "Məs: 10-cu sinif / Məzun",
        "reg-pl-age-25": "Məs: 25",
        "reg-opt-tr": "Türk bölməsi",
        "reg-opt-sel-prog": "Proqram seçin",
        "reg-opt-sat": "SAT",
        "reg-opt-ielts": "IELTS",
        "reg-opt-toefl": "TOEFL",
        "reg-opt-dim": "DİM (Abituriyent)",
        "reg-opt-lang": "Xarici Dil Hazırlıqları",
        "reg-opt-sel-serv": "Xidmət seçin",
        "reg-opt-swim": "Üzgüçülük",
        "reg-opt-fit": "Fitness",
        "reg-opt-pilates": "Pilates",
        "reg-opt-yoga": "Yoga",
        "reg-opt-mom": "Ana və uşaqlar",
        "reg-pl-ali": "Məs: Əli",
        ...
        "reg-student-name": "ŞAGİRDİN ADI",
        "reg-student-surname": "ŞAGİRDİN SOYADI",
        "reg-sector": "Müraciət etdiyi bölmə",
        "reg-class": "Müraciət etdiyi sinif",
        "reg-prev-school": "Hazırda təhsil aldığı təhsil müəssisəsi ( bağça və məktəb)",
        "reg-parent-phone": "VALİDEYNİN ƏLAQƏ NÖMRƏSİ",
        "reg-email": "MAİL ÜNVANI",
    ...
    "school-mont": "Evrika Montessori<br>Uşaq Akademiyası",
    ...
    "badge-mont-school": "Montessori departamenti I- XI",
    "addr-zumrud": "Yəhya Bakuvi küç. 42, Zümrüd Yaşayış Kompleksi",
    "school-support": "Akademik Dəstək",
    "school-eduhome": "Evrika Victory Colleges by Evrika Mərkəzi",
    ...
    "about-founder-title-1": "TƏSİSÇİNİN",
    ...
    "home-sec3-tag": "Victory Colleges by Evrika Mərkəzi",
    "home-sec3-badge": "Akademik Dəstək",
    "home-sec3-title": "Victory Colleges<br>Təhsil Mərkəzi",
    ...
    "branch-eduhome-title": "Evrika Victory Colleges by Evrika Mərkəzi",
    ...
    "quote-ha1-part1": "Təhsil hər bir dövlətin, ölkənin, cəmiyyətin həyatının, fəaliyyətinin mühüm bir sahəsidir. Cəmiyyət ",
    "quote-ha1-part2": "təhsilsiz inkişaf edə bilməz.",
    "quote-ha2-part1": "“Hər bir xalqın tərəqqisi onun ",
    "quote-ha2-part2": "təhsil səviyyəsi",
    "quote-ha2-part3": " ilə müəyyən olunur.”",
    "quote-ia-part1": "Təhsil bizim ",
    "quote-ia-part2": "gələcəyimizdir!",
    "quote-ma-part1": "Müasir dünyada hər bir ölkənin inkişafı, onun dünya birliyinə inteqrasiyası üçün ",
    "quote-ma-part2": "təhsilin rolu əvəzsizdir.",
    ...
    "form-child-name": "ŞAGİRDİN ADI",
    "form-child-surname": "ŞAGİRDİN SOYADI",
    ...
    "form-email": "E-mail",
    "form-submit": "Göndər",
    "form-ph-name": "Məs: Əli",
    "form-ph-surname": "Məs: Əliyev",
    "form-opt-center": "Təhsil Mərkəzi seçin",
    "form-opt-section": "Əvvəlcə mərkəz seçin",
    "form-opt-section2": "Bölmə seçin",
    "form-opt-class": "Sinif seçin",
    "form-ph-school": "Məs: 20 nömrəli məktəb",
    "form-ph-email": "nümunə@mail.com",
    "branch-nerimanov": "Evrika BETL Nərimanov filialı",
    "branch-genclik": "Evrika BETL Gənclik filialı",
    "branch-montessori": "Montessori Kids Academy",
    "branch-eduhome": "Victory Colleges by Evrika",
    "class-preschool": "Məktəbəqədər",
    "class-1": "1-ci sinif",
    "class-2": "2-ci sinif",
    "class-3": "3-cü sinif",
    "class-4": "4-cü sinif",
    ...
    "class-8": "8-ci sinif",
    "class-9": "9-cu sinif",
    "class-10": "10-cu sinif",
    "class-11": "11-ci sinif",
    "sector-az": "Azərbaycan bölməsi",
    "sector-ru": "Rus bölməsi",
    "sector-en": "İngilis bölməsi",
    "sector-tr": "Türk bölməsi",
    "sector-mont": "Montessori məktəbi (ibtidai)",
    "sector-sat": "SAT hazırlığı",
    "sector-ielts": "IELTS hazırlığı",
    "sector-toefl": "TOEFL hazırlığı",
    "sector-dim": "DİM hazırlığı",
    "sector-other": "Digər",
    ...
    "nav-eduhome": "Victory Colleges by Evrika",
...
,
    ...
    "ach-desc": "15 illik akademik təcrübəmiz şagirdlərimizin uğurlu gələcəyidir!",
    "ach-gallery": "QALEREYA",
    "ach-card-title": "Evrika Uğurları",
    "ach-modal-badge": "FƏXRİMİZ",
    "ach-modal-info": "MƏLUMAT",
    "news-eyebrow": "XƏBƏRLƏR",
    "news-title": "Xəbərlər",
    "news-desc": "Ən son xəbərlər, layihələr və xəbərlərimizlə tanış olun. Təhsil mühitimizdə baş verən ən son hadisələr.",
    "news-loading": "Xəbərlər yüklənir...",
    "news-empty": "Hələ ki, heç bir xəbər yoxdur.",
    "news-error": "Xəbərlər yüklənərkən xəta baş verdi.",
    "news-read-more": "Daha ətraflı",
    "index-all-news": "Bütün Xəbərlər",
    "news-detail-other": "Digər Xəbərlər",
    "lisey-branch": "NƏRİMANOV FİLİALI",
    "lisey-title": "Evrika Beynəlxalq <br> <span class=\"accent\">Elm və Texnologiya Liseyi</span>",
    "lisey-hero-desc": "15 illik akademik təcrübəyə əsaslanan Evrika Liseyi, məktəbəqədər mərhələdən XI sinfə qədər hərtərəfli inkişafı təmin edən müasir və nəticə yönümlü təhsil modelidir.",
    "lisey-about-title": "Milli Kurikulum, <em>Cambridge</em> və <em>STEAM/iSTEM</em>",
    "lisey-about-p1": "Məktəbəqədər hazırlıq və I–XI siniflər üzrə təşkil olunan tədris prosesi Milli kurikulum, Beynəlxalq Cambridge proqramı və STEAM/iSTEM modeli əsasında qurulur.",
    "lisey-about-p2": "Uşaq mərkəzli yanaşma, davamlı monitorinq və fərdi inkişaf prinsipləri şagirdlərdə analitik düşüncə, şəxsiyyət inkişafı və gələcəyə hazırlığı formalaşdırır.",
    "lisey-levels-title": "Təhsil <em>Pillələrimiz</em>",
    "lisey-levels-desc": "Məktəbəhazırlıqdan IX sinfə qədər hər bir pillədə fərdi yanaşma və beynəlxalq standartlar.",
    "lisey-lvl1-title": "Məktəbəhazırlıq",
    "lisey-lvl1-desc": "5-6 yaşlı uşaqlar üçün iSteam və STEAM əsaslı kəşfiyyat dünyası...",
    "lisey-lvl2-title": "İbtidai Təhsil",
    "lisey-lvl2-desc": "1-4-cü siniflərdə məntiqi təfəkkürün və təməl bacarıqların formalaşdırılması...",
    "lisey-lvl3-title": "Ümumi Orta Təhsil",
    "lisey-lvl3-desc": "5-9-cu siniflərdə dərinləşdirilmiş fənlər və aylıq monitorinqlər...",
    "lisey-lvl4-title": "Tam Orta Təhsil",
    "lisey-lvl4-desc": "10-11-ci siniflərdə ixtisaslaşma, SAT, IELTS və universitet hazırlığı...",
    "lisey-read-more": "Daha çox oxu",
    "lisey-acad-eyebrow": "AKADEMİK",
    "lisey-acad-title": "Bölmələr və <em>bilinqval təhsil</em>",
    "lisey-acad-desc": "2026/2027-ci tədris ilindən Azərbaycan və Rus bölmələrində bilinqval siniflər fəaliyyət göstərir.",
    "lisey-sec-az": "Azərbaycan <br>Bölməsi",
    "lisey-sec-ru": "Rus <br>Bölməsi",
    "lisey-sec-en": "İngilis <br>Bölməsi",
    "lisey-langs-title": "Tədris Olunan <em>Xarici Dillər</em>",
    "lisey-lang-en": "İngilis",
    "lisey-lang-de": "Alman",
    "lisey-lang-fr": "Fransız",
    "lisey-lang-ru": "Rus",
    "lisey-lang-cn": "Çin",
    "lisey-steam-eyebrow": "EVRİKA / ACADEMIC",
    "lisey-steam-title": "<em>iSteam</em> və <em>STEAM</em>",
    "lisey-steam-p1": "Yüksək texnoloji yanaşma, iSteam əsaslı tədris, robototexnika və yaradıcı mühəndislik prinsipləri üzərində qurulub.",
    "lisey-steam-p2": "Liseyimizdə tədris prosesi müasir iSteam (Beynəlxalq STEAM) proqramı üzərində qurulub. Bu yanaşma Cambridge proqramı ilə inteqrasiya olunaraq şagirdlərdə mühəndislik düşüncəsi, kodlaşdırma və problem həlletmə bacarıqlarını inkişaf etdirir.",
    "lisey-clubs-art": "YARADICILIQ <em>KLUBLARI</em>",
    "lisey-club-music": "MUSİQİ",
    "lisey-club-art": "ART",
    "lisey-club-chess": "ŞAHMAT",
    "lisey-club-piano": "PİANO",
    "lisey-clubs-sport": "İDMAN <em>KLUBLARI</em>",
    "lisey-club-swim": "ÜZGÜÇÜLÜK",
    "lisey-club-football": "FUTBOL",
    "lisey-club-basketball": "BASKETBOL",
    "lisey-club-volleyball": "VOLEYBOL",
    "lisey-club-judo": "CÜDO",
    "lisey-club-archery": "OXATMA",
    "lisey-club-gymnastics": "GİMNASTİKA",
    "lisey-support-eyebrow": "DƏSTƏK VƏ TƏHLÜKƏSİZLİK",
    "lisey-support-title": "Xidmətlərimiz və <em>İnfrastruktur</em>",
    "lisey-sup-food": "Qidalanma",
    "lisey-sup-food-desc": "Bədənin qidası yemək, ağlın qidası elmdir! 3 dəfəlik sağlam menyu...",
    "lisey-sup-trans": "Nəqliyyat",
    "lisey-sup-trans-desc": "Təhlükəsiz və rahat şəkildə evdən məktəbə çatdırılma xidməti...",
    "lisey-sup-sec": "Təhlükəsizlik",
    "lisey-sup-sec-desc": "24 saat peşəkar mühafizə və turniket nəzarət sistemi...",
    "lisey-sup-psy": "Psixoloji Xidmət",
    "lisey-sup-psy-desc": "Şagirdlərin emosional və sosial sağlamlıq xidmətləri...",
    "lisey-sup-med": "Tibbi Xidmət",
    "lisey-sup-med-desc": "İxtisaslı həkim nəzarəti və ilk tibbi yardım təminatı...",
    "lisey-cta-quote": "“Bu günün doğru seçimi, sabahın uğurudur.”",
    "lisey-cta-desc": "Evrika Elm və Texnologiya Liseyi — ELM VƏ TEXNOLOGİYA dünyasına xoş gəlmisiniz!",
    "lisey-cta-btn": "Qeydiyyatdan Keç",
    "lisey-cta-address": "Filalımızın Ünvanı",
    "lisey-cta-social": "Sosial Media",
    "lisey-cta-insta-title": "Bizi İnstagramda İzləyin",
  ...
  en: {
        ...
        "reg-school-montessori": "Evrika Montessori Kids Academy",
        "reg-school-eduhome": "Victory Colleges Preparation Center",
        "reg-school-zumrud": "Zumrud<br>Women<br>Club",
        "reg-submit": "SUBMIT APPLICATION",
        "reg-child-name": "ŞAGİRDİN ADI",
        "reg-child-surname": "ŞAGİRDİN SOYADI",
        "reg-child-sector": "Sector Applied For",
        "reg-child-age": "Child's Age",
        "reg-parent-contact": "Parent's Contact Number",
        "reg-your-name": "Your First Name",
        "reg-your-surname": "Your Last Name",
        "reg-your-program": "Program Applied For",
        "reg-current-class": "Current Grade (or Graduate)",
        "reg-contact-num": "Contact Number",
        "reg-your-service": "Service Applied For",
        "reg-your-age": "Your Age",
        "reg-pl-age-4": "e.g., 4 or 4.5",
        "reg-pl-zumrud": "e.g., Zumrud",
        "reg-pl-aliyeva": "e.g., Aliyeva",
        "reg-pl-grade10": "e.g., 10th Grade / Graduate",
        "reg-pl-age-25": "e.g., 25",
        "reg-opt-tr": "Turkish Sector",
        "reg-opt-sel-prog": "Select Program",
        "reg-opt-sat": "SAT",
        "reg-opt-ielts": "IELTS",
        "reg-opt-toefl": "TOEFL",
        "reg-opt-dim": "SEC (Abituriyent)",
        "reg-opt-lang": "Foreign Language Courses",
        "reg-opt-sel-serv": "Select Service",
        "reg-opt-swim": "Swimming",
        "reg-opt-fit": "Fitness",
        "reg-opt-pilates": "Pilates",
        "reg-opt-yoga": "Yoga",
        "reg-opt-mom": "Mother & Kids",
        "reg-pl-ali": "e.g., Ali",
    ...
    "badge-mont-school": "Montessori Department I- XI",
    "addr-zumrud": "Yahya Bakuvi st. 42, Zumrud Residential Complex",
    "school-support": "Academic Support",
    "school-eduhome": "Evrika Victory Colleges Prep Center",
    ...
    "about-founder-title-1": "FOUNDER\'S",
    ...
    "modal-title": "The success of the future starts here..",
    ...
    "home-sec3-tag": "Victory Colleges Prep Center",
    "home-sec3-badge": "Academic Support",
    "home-sec3-title": "Victory Colleges<br>Education Center",
    ...
    "branch-eduhome-title": "Evrika Victory Colleges Preparation Center",
    "branch-zumrud-title": "Zumrud Women Club by Evrika Active Life",
    ...
    "quote-ha1-part1": "Education is an important area of the life and activity of every state, country, and society. A society ",
    "quote-ha1-part2": "cannot develop without education.",
    "quote-ha2-part1": "“The progress of every nation is determined by its ",
    "quote-ha2-part2": "level of education",
    "quote-ha2-part3": ".”",
    "quote-ia-part1": "Education is our ",
    "quote-ia-part2": "future!",
    "quote-ma-part1": "In the modern world, for the development of every country and its integration into the global community, ",
    "quote-ma-part2": "the role of education is irreplaceable.",
    ...
    "form-submit": "Submit",
    "form-ph-name": "Ex: Ali",
    "form-ph-surname": "Ex: Aliyev",
    "form-opt-center": "Select an Education Center",
    "form-opt-section": "Select a center first",
    "form-opt-section2": "Select a section",
    "form-opt-class": "Select a grade",
    "form-ph-school": "Ex: School No. 20",
    "form-ph-email": "example@mail.com",
    "branch-nerimanov": "Evrika BETL Narimanov Branch",
    "branch-genclik": "Evrika BETL Ganjlik Branch",
    "branch-montessori": "Montessori Kids Academy",
    "branch-eduhome": "Victory Colleges Preparation",
    "class-preschool": "Preschool",
    "class-1": "1st Grade",
    "class-2": "2nd Grade",
    "class-3": "3rd Grade",
    "class-4": "4th Grade",
    ...
    "class-10": "10th Grade",
    "class-11": "11th Grade",
    "sector-az": "Azerbaijani Section",
    "sector-ru": "Russian Section",
    "sector-en": "English Section",
    "sector-tr": "Turkish Section",
    "sector-mont": "Montessori School (Primary)",
    "sector-sat": "SAT Preparation",
    "sector-ielts": "IELTS Preparation",
    "sector-toefl": "TOEFL Preparation",
    "sector-dim": "SEC (DİM) Preparation",
    "sector-other": "Other",
    "news-eyebrow": "NEWS",
    ...
    "nav-eduhome": "Victory Colleges Prep",
...
,
    ...
    "ach-title": "Our Achievements",
    "ach-desc": "Our 15 years of academic experience is the successful future of our students!",
    "ach-gallery": "GALLERY",
    "ach-card-title": "Evrika Achievements",
    "ach-modal-badge": "OUR PRIDE",
    "ach-modal-info": "INFORMATION",
    "news-eyebrow": "NEWS & UPDATES",
    "news-title": "News",
    "news-desc": "Get acquainted with our latest news, projects, and updates. The latest events happening in our educational environment.",
    "news-loading": "Loading news...",
    "news-empty": "There are no news available yet.",
    "news-error": "An error occurred while loading news.",
    "news-read-more": "Read more",
    "index-all-news": "All News",
    "news-detail-other": "Other News",
    "lisey-branch": "NARIMANOV BRANCH",
    "lisey-title": "Evrika International <br> <span class=\"accent\">Science and Technology Lyceum</span>",
    "lisey-hero-desc": "Based on 15 years of academic experience, Evrika Lyceum is a modern and results-oriented education model that ensures comprehensive development from preschool to grade XI.",
    "lisey-about-title": "National Curriculum, <em>Cambridge</em> and <em>STEAM/iSTEM</em>",
    "lisey-about-p1": "The educational process for preschool and grades I-XI is built on the National curriculum, the International Cambridge program, and the STEAM/iSTEM model.",
    "lisey-about-p2": "A child-centered approach, continuous monitoring, and personal development principles foster analytical thinking, character development, and readiness for the future in students.",
    "lisey-levels-title": "Our Education <em>Levels</em>",
    "lisey-levels-desc": "Personalized approach and international standards at every level from preschool to grade IX.",
    "lisey-lvl1-title": "Preschool",
    "lisey-lvl1-desc": "A world of exploration based on iSteam and STEAM for 5-6 year olds...",
    "lisey-lvl2-title": "Primary Education",
    "lisey-lvl2-desc": "Formation of logical thinking and fundamental skills in grades 1-4...",
    "lisey-lvl3-title": "General Secondary Education",
    "lisey-lvl3-desc": "In-depth subjects and monthly monitoring in grades 5-9...",
    "lisey-lvl4-title": "Full Secondary Education",
    "lisey-lvl4-desc": "Specialization, SAT, IELTS, and university preparation in grades 10-11...",
    "lisey-read-more": "Read more",
    "lisey-acad-eyebrow": "ACADEMICS",
    "lisey-acad-title": "Sections and <em>bilingual education</em>",
    "lisey-acad-desc": "From the 2026/2027 academic year, bilingual classes operate in the Azerbaijani and Russian sections.",
    "lisey-sec-az": "Azerbaijani <br>Section",
    "lisey-sec-ru": "Russian <br>Section",
    "lisey-sec-en": "English <br>Section",
    "lisey-langs-title": "Taught <em>Foreign Languages</em>",
    "lisey-lang-en": "English",
    "lisey-lang-de": "German",
    "lisey-lang-fr": "French",
    "lisey-lang-ru": "Russian",
    "lisey-lang-cn": "Chinese",
    "lisey-steam-eyebrow": "EVRIKA / ACADEMIC",
    "lisey-steam-title": "<em>iSteam</em> and <em>STEAM</em>",
    "lisey-steam-p1": "Built on a high-tech approach, iSteam-based education, robotics, and creative engineering principles.",
    "lisey-steam-p2": "The educational process at our lyceum is built on the modern iSteam (International STEAM) program. This approach, integrated with the Cambridge program, develops engineering thinking, coding, and problem-solving skills in students.",
    "lisey-clubs-art": "CREATIVITY <em>CLUBS</em>",
    "lisey-club-music": "MUSIC",
    "lisey-club-art": "ART",
    "lisey-club-chess": "CHESS",
    "lisey-club-piano": "PIANO",
    "lisey-clubs-sport": "SPORTS <em>CLUBS</em>",
    "lisey-club-swim": "SWIMMING",
    "lisey-club-football": "FOOTBALL",
    "lisey-club-basketball": "BASKETBALL",
    "lisey-club-volleyball": "VOLLEYBALL",
    "lisey-club-judo": "JUDO",
    "lisey-club-archery": "ARCHERY",
    "lisey-club-gymnastics": "GYMNASTICS",
    "lisey-support-eyebrow": "SUPPORT AND SECURITY",
    "lisey-support-title": "Our Services and <em>Infrastructure</em>",
    "lisey-sup-food": "Nutrition",
    "lisey-sup-food-desc": "Food is the nutrition of the body, science is the nutrition of the mind! A healthy 3-meal menu...",
    "lisey-sup-trans": "Transport",
    "lisey-sup-trans-desc": "Safe and comfortable delivery service from home to school...",
    "lisey-sup-sec": "Security",
    "lisey-sup-sec-desc": "24-hour professional security and turnstile control system...",
    "lisey-sup-psy": "Psychological Service",
    "lisey-sup-psy-desc": "Emotional and social health services for students...",
    "lisey-sup-med": "Medical Service",
    "lisey-sup-med-desc": "Qualified medical supervision and first aid provision...",
    "lisey-cta-quote": "“The right choice today is tomorrow's success.”",
    "lisey-cta-desc": "Evrika Science and Technology Lyceum — Welcome to the world of SCIENCE AND TECHNOLOGY!",
    "lisey-cta-btn": "Register Now",
    "lisey-cta-address": "Branch Address",
    "lisey-cta-social": "Social Media",
    "lisey-cta-insta-title": "Follow Us on Instagram",
  ...
  ru: {
        ...
        "reg-school-eduhome": "Victory Colleges Учебный Центр",
        "reg-school-zumrud": "Зюмруд<br>Женский<br>Клуб",
        "reg-submit": "ПОДАТЬ ЗАЯВКУ",
        "reg-child-name": "ŞAGİRDİN ADI",
        "reg-child-surname": "ŞAGİRDİN SOYADI",
        "reg-child-sector": "Сектор",
        "reg-child-age": "Возраст ребенка",
        "reg-parent-contact": "Контактный номер родителя",
        "reg-your-name": "Ваше имя",
        "reg-your-surname": "Ваша фамилия",
        "reg-your-program": "Программа",
        "reg-current-class": "Текущий класс (или выпускник)",
        "reg-contact-num": "Контактный номер",
        "reg-your-service": "Желаемая услуга",
        "reg-your-age": "Ваш возраст",
        "reg-pl-age-4": "Например: 4 или 4.5",
        "reg-pl-zumrud": "Например: Зюмруд",
        "reg-pl-aliyeva": "Например: Алиева",
        "reg-pl-grade10": "Например: 10 класс / Выпускник",
        "reg-pl-age-25": "Например: 25",
        "reg-opt-tr": "Турецкий сектор",
        "reg-opt-sel-prog": "Выберите программу",
        "reg-opt-sat": "SAT",
        "reg-opt-ielts": "IELTS",
        "reg-opt-toefl": "TOEFL",
        "reg-opt-dim": "ГЕЦ (Абитуриент)",
        "reg-opt-lang": "Курсы иностранных языков",
        "reg-opt-sel-serv": "Выберите услугу",
        "reg-opt-swim": "Плавание",
        "reg-opt-fit": "Фитнес",
        "reg-opt-pilates": "Пилатес",
        "reg-opt-yoga": "Йога",
        "reg-opt-mom": "Мама и дети",
    ...
    "school-mont": "Детская Академия<br>Evrika Montessori",
    ...
    "badge-mont-school": "Департамент Монтессори I- XI",
    "addr-zumrud": "Ул. Яхьи Бакуви 42, Жилой комплекс Зумруд",
    "school-support": "Академическая Поддержка",
    "school-eduhome": "Центр Подготовки Evrika Victory Colleges",
    ...
    "about-founder-title-1": "ПОСЛАНИЕ",
    ...
    "modal-title": "Успех будущего начинается здесь..",
    ...
    "home-sec3-tag": "Подготовительный Центр Victory Colleges",
    "home-sec3-badge": "Академическая поддержка",
    "home-sec3-title": "Victory Colleges<br>Образовательный Центр",
    ...
    "branch-eduhome-title": "Подготовительный Центр Victory Colleges",
    ...
    "quote-ha1-part1": "Образование – важная сфера жизни и деятельности каждого государства, страны и общества. Общество ",
    "quote-ha1-part2": "не может развиваться без образования.",
    "quote-ha2-part1": "«Прогресс каждого народа определяется его ",
    "quote-ha2-part2": "уровнем образования",
    "quote-ha2-part3": "».",
    "quote-ia-part1": "Образование – это наше ",
    "quote-ia-part2": "будущее!",
    "quote-ma-part1": "В современном мире для развития каждой страны и её интеграции в мировое сообщество ",
    "quote-ma-part2": "роль образования незаменима.",
    ...
    "form-ph-name": "Напр: Али",
    "form-ph-surname": "Напр: Алиев",
    "form-opt-center": "Выберите учебный центр",
    "form-opt-section": "Сначала выберите центр",
    "form-opt-section2": "Выберите отделение",
    "form-opt-class": "Выберите класс",
    "form-ph-school": "Напр: Школа №20",
    "form-ph-email": "пример@mail.com",
    "branch-nerimanov": "Филиал Evrika BETL Нариманов",
    "branch-genclik": "Филиал Evrika BETL Гянджлик",
    "branch-montessori": "Montessori Kids Academy",
    "branch-eduhome": "Подготовка Victory Colleges",
    "class-preschool": "Дошкольное образование",
    "class-1": "1-й класс",
    "class-2": "2-й класс",
    "class-3": "3-й класс",
    "class-4": "4-й класс",
    ...
    "class-10": "10-й класс",
    "class-11": "11-й класс",
    "sector-az": "Азербайджанский сектор",
    "sector-ru": "Русский сектор",
    "sector-en": "Английский сектор",
    "sector-tr": "Турецкий сектор",
    "sector-mont": "Школа Монтессори (начальная)",
    "sector-sat": "Подготовка к SAT",
    "sector-ielts": "Подготовка к IELTS",
    "sector-toefl": "Подготовка к TOEFL",
    "sector-dim": "Подготовка к ГЭЦ (DİM)",
    "sector-other": "Другое",
...
,
    ...
    "ach-title": "Наши Достижения",
    "ach-desc": "Наш 15-летний академический опыт — это успешное будущее наших учеников!",
    "ach-gallery": "ГАЛЕРЕЯ",
    "ach-card-title": "Достижения Эврики",
    "ach-modal-badge": "НАША ГОРДОСТЬ",
    "ach-modal-info": "ИНФОРМАЦИЯ",
    "news-eyebrow": "ОБНОВЛЕНИЯ",
    "news-title": "Новости",
    "news-desc": "Ознакомьтесь с нашими последними новостями, проектами и обновлениями. Последние события в нашей образовательной среде.",
    "news-loading": "Загрузка новостей...",
    "news-empty": "Новостей пока нет.",
    "news-error": "Произошла ошибка при загрузке новостей.",
    "news-read-more": "Подробнее",
    "index-all-news": "Все Новости",
    "news-detail-other": "Другие Новости",
    "lisey-branch": "НАРИМАНОВСКИЙ ФИЛИАЛ",
    "lisey-title": "Международный Лицей <br> <span class=\"accent\">Науки и Технологий Эврика</span>",
    "lisey-hero-desc": "Лицей Эврика, основанный на 15-летнем академическом опыте, — это современная и ориентированная на результат модель образования, обеспечивающая всестороннее развитие с дошкольного возраста до XI класса.",
    "lisey-about-title": "Национальный Курикулум, <em>Cambridge</em> и <em>STEAM/iSTEM</em>",
    "lisey-about-p1": "Учебный процесс для дошкольников и I-XI классов строится на основе Национального курикулума, международной программы Cambridge и модели STEAM/iSTEM.",
    "lisey-about-p2": "Ориентация на ребенка, постоянный мониторинг и принципы индивидуального развития формируют у учащихся аналитическое мышление, развитие личности и готовность к будущему.",
    "lisey-levels-title": "Наши Ступени <em>Обучения</em>",
    "lisey-levels-desc": "Индивидуальный подход и международные стандарты на каждой ступени от дошкольной подготовки до IX класса.",
    "lisey-lvl1-title": "Дошкольная подготовка",
    "lisey-lvl1-desc": "Мир открытий на основе iSteam и STEAM для детей 5-6 лет...",
    "lisey-lvl2-title": "Начальное образование",
    "lisey-lvl2-desc": "Формирование логического мышления и базовых навыков в 1-4 классах...",
    "lisey-lvl3-title": "Общее среднее образование",
    "lisey-lvl3-desc": "Углубленное изучение предметов и ежемесячный мониторинг в 5-9 классах...",
    "lisey-lvl4-title": "Полное среднее образование",
    "lisey-lvl4-desc": "Специализация, подготовка к SAT, IELTS и поступлению в университет в 10-11 классах...",
    "lisey-read-more": "Читать далее",
    "lisey-acad-eyebrow": "АКАДЕМИЧЕСКАЯ ЧАСТЬ",
    "lisey-acad-title": "Сектора и <em>билингвальное обучение</em>",
    "lisey-acad-desc": "С 2026/2027 учебного года в азербайджанском и русском секторах действуют билингвальные классы.",
    "lisey-sec-az": "Азербайджанский <br>Сектор",
    "lisey-sec-ru": "Русский <br>Сектор",
    "lisey-sec-en": "Английский <br>Сектор",
    "lisey-langs-title": "Преподаваемые <em>Иностранные Языки</em>",
    "lisey-lang-en": "Английский",
    "lisey-lang-de": "Немецкий",
    "lisey-lang-fr": "Французский",
    "lisey-lang-ru": "Русский",
    "lisey-lang-cn": "Китайский",
    "lisey-steam-eyebrow": "ЭВРИКА / ACADEMIC",
    "lisey-steam-title": "<em>iSteam</em> и <em>STEAM</em>",
    "lisey-steam-p1": "Основан на высокотехнологичном подходе, обучении на базе iSteam, робототехнике и принципах творческой инженерии.",
    "lisey-steam-p2": "Учебный процесс в нашем лицее построен на современной программе iSteam (International STEAM). Этот подход, интегрированный с программой Cambridge, развивает у учащихся инженерное мышление, навыки кодирования и решения проблем.",
    "lisey-clubs-art": "ТВОРЧЕСКИЕ <em>КЛУБЫ</em>",
    "lisey-club-music": "МУЗЫКА",
    "lisey-club-art": "ИСКУССТВО",
    "lisey-club-chess": "ШАХМАТЫ",
    "lisey-club-piano": "ПИАНИНО",
    "lisey-clubs-sport": "СПОРТИВНЫЕ <em>КЛУБЫ</em>",
    "lisey-club-swim": "ПЛАВАНИЕ",
    "lisey-club-football": "ФУТБОЛ",
    "lisey-club-basketball": "БАСКЕТБОЛ",
    "lisey-club-volleyball": "ВОЛЕЙБОЛ",
    "lisey-club-judo": "ДЗЮДО",
    "lisey-club-archery": "СТРЕЛЬБА ИЗ ЛУКА",
    "lisey-club-gymnastics": "ГИМНАСТИКА",
    "lisey-support-eyebrow": "ПОДДЕРЖКА И БЕЗОПАСНОСТЬ",
    "lisey-support-title": "Наши Услуги и <em>Инфраструктура</em>",
    "lisey-sup-food": "Питание",
    "lisey-sup-food-desc": "Пища — это питание тела, а наука — питание ума! Здоровое 3-разовое питание...",
    "lisey-sup-trans": "Транспорт",
    "lisey-sup-trans-desc": "Безопасная и комфортная доставка из дома в школу...",
    "lisey-sup-sec": "Безопасность",
    "lisey-sup-sec-desc": "Круглосуточная профессиональная охрана и система турникетного контроля...",
    "lisey-sup-psy": "Психологическая Служба",
    "lisey-sup-psy-desc": "Услуги по эмоциональному и социальному здоровью учащихся...",
    "lisey-sup-med": "Медицинская Служба",
    "lisey-sup-med-desc": "Квалифицированный медицинский контроль и оказание первой медицинской помощи...",
    "lisey-cta-quote": "«Правильный выбор сегодня — это успех завтра».",
    "lisey-cta-desc": "Лицей Науки и Технологий Эврика — Добро пожаловать в мир НАУКИ И ТЕХНОЛОГИЙ!",
    "lisey-cta-btn": "Зарегистрироваться",
    "lisey-cta-address": "Адрес Филиала",
    "lisey-cta-social": "Социальные Сети",
    "lisey-cta-insta-title": "Следите за нами в Instagram",
    "lisey-cta-insta-btn": "Наша Страница"
}
};
...
window.addEventListener('storage', (e) => {
  if (e.key === 'evrika-lang') {
    ...
    const codeSpans = document.querySelectorAll('.lang-text');
    codeSpans.forEach(span => span.innerText = newLang.toUpperCase());
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const codeSpans = document.querySelectorAll('.lang-text');
    codeSpans.forEach(span => span.innerText = savedLang.toUpperCase());
