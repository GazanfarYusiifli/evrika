...
mobile_nav_replacement = r"""    <div class="close-mobile" id="mobile-close"><i class="fas fa-times"></i></div>
...
for filepath in glob.glob('*.html'):
    ...
    content = re.sub(r'<div class="close-mobile" id="mobile-close">.*?<div class="mobile-nav-links">', mobile_nav_replacement, content, flags=re.DOTALL)

    with open(filepath, 'w', encoding='utf-8') as f:
        f.write(content)

print("Mobile nav perfectly reverted.")
