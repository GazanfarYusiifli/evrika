...
url = 'https://gziuhrlvagflokivfgwt.supabase.co/rest/v1/parent_testimonials'
headers = {
...
data = [
    {
        "payload": {
            "name": "Zaur İsmayılov",
            "status": "2019",
            "quote": "Evrika Liseyini seçdiyimiz üçün çox məmnunuq. Burada uşaqlara həm savadlı təhsil verilir, həm də onların fərdi inkişafına xüsusi diqqət yetirilir. Müəllimlər çox qayğıkeş və peşəkardırlar. Övladım dərslərə marağı artıb, özünü daha rahat və inamlı hiss edir. Məktəbdə yaradılan təhlükəsiz və nizamlı mühit də valideyn olaraq bizi rahat edir.",
            "type": "text",
