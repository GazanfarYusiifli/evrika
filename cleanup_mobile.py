...
for filepath in glob.glob('*.html'):
    ...
    # Replace everything between close-mobile and mobile-nav-links
    # This cleans up any duplicate garbage we generated there.
...
print("Mobile dropdown wrapper cleaned up in all HTML files.")
